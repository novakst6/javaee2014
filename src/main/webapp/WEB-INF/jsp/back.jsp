...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Obsluhovač - JEE Bar 2014</title>
                ...
                <link rel="stylesheet" type="text/css" href="files/web/css/back.css" />
	...
	<body>
		...
		<script type="text/javascript">
			...
			require(['backbone'], function(){
				...
				require(['apps/back/App'], function(){
					...
					window.app = {
                                                ...
                                                api: rootURL + "/api/",
                                                files: rootURL + "/files/",
                                                pages: rootURL + "/files/web/js/apps/back/"
					};
                                        
                                        window.app.app = new BackApp();
